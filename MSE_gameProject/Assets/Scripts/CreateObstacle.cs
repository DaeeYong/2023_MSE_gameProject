...
public class CreateObstacle : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       if (Physics.Raycast(ray, out hit, 100, layerMask))
       {
            ...
            Vector3 cursorPosition = new Vector3(hit.transform.position.x + (cursorObj.transform.localScale.x * 0.25f), hit.transform.position.y + hit.transform.localScale.y, hit.transform.position.z);
